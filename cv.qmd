...
# Econometrics in Management / Marketing `(Bachelor)`
...
## Data Mining in Marketing: Data Driven Customer Analytics with Machine Learning `(Master)`
...
::: {.callout-note collapse="true" style="gray" appearance="minimal" icon="false"}
## Applications of Generative AI in Marketing `(Bachelor)`
...
::: {.callout-note collapse="true" style="gray" appearance="minimal" icon="false"}
## Generative AI in Marketing `(Master)`
...
-   **Type:** Bachelor's Level (x8) & Master's Level (x1), Co-supervise with Prof. Bernd Skiera

-   **Period:** Winter 2024/25, Summer 2024
:::
